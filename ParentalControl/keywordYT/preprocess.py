...
import tarfile
from .manage_models import get_model_from_disk

model_ = "en_core_web_sm-2.3.1"
 
model_location = get_model_from_disk(model_)

class preprocess():
    def __init__(self):
        self.model = spacy.load(model_location)
...
class preprocessK():
    def __init__(self,path=None):
        ...
        '''
        self.stopwords = preprocessK.load_stopwords()
